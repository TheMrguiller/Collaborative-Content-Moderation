...
class Profanity:
    ...
    def _populate_words_to_wordset(self, words, *, whitelist_words=None):
        ...
        for word in set(words):
            ...
            variated_word=VaryingString(word, char_map=self.CHARS_MAPPING)
            # self.censor_to_original[variated_word]=word
            all_censor_words.append(variated_word)
    ...
    def _hide_swear_words(self, text, censor_char):
        ...
        for index, char in iter(enumerate(text)):
            ...
            contains_swear_word, end_index, original_word = any_next_words_form_swear_word(
            ...
            if cur_word.lower() in self.CENSOR_WORDSET:
                index_= self.CENSOR_WORDSET.index(cur_word.lower())
                # print(index_)
                original_word= str(self.CENSOR_WORDSET[index_])
                # print(original_word)
                cur_word = original_word
